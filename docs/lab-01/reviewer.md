...
|----|--------|------------------|
|  feature/1-project-foundation   | feature/1-project-foundation | Seems alright, everything starts up |
|  feature/2-health-check  | feature/2-health-check | Looks good! End test |
